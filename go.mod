...
require (
	google.golang.org/genproto v0.0.0-20240924160255-9d4c2d233b61 // indirect; Or another stable version
	google.golang.org/protobuf v1.34.2 // indirect; Ensure you switch to google.golang.org/protobuf instead of github.com/golang/protobuf
)
